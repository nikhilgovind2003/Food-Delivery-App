...
const Footer = () => {
  return (
    <>
      <div className=" lg:grid grid-cols-[1fr_1fr] w-full bg-gray-600  lg:py-12 lg:px-24 text-white mb-0">
      ...
      <hr />
      <div className=" bg-gray-600 text-center font-semibold py-8 px-2 text-white">
